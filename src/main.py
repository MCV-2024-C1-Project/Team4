...
def main():
	...
	# Read the color space, k value, query dataset path, and test flag from the command line
	...
	# 		  similarity to all museum images (BBDD). The best results   
	# 		  are obtained using the following similarity measures:
