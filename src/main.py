...
def main():
	...
	for query_lab_img in qsd1_lab_histograms:
		res_m1_k1.append(
			compute_similarities(query_hist=query_lab_img, bbdd_histograms=bbdd_lab_histograms,
								 method=cv.HISTCMP_HELLINGER,
								 k=k_value1)[1])
		res_m1_k5.append((compute_similarities(query_hist=query_lab_img, bbdd_histograms=bbdd_lab_histograms,
	...
	for query_hsv_img in qsd1_hsv_histograms:
		res_m2_k1.append(
			compute_similarities(query_hist=query_hsv_img, bbdd_histograms=bbdd_hsv_histograms,
								 method=cv.HISTCMP_HELLINGER,
								 k=k_value1)[1])
		res_m2_k5.append(
			compute_similarities(query_hist=query_hsv_img, bbdd_histograms=bbdd_hsv_histograms,
