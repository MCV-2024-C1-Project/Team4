...
for image_path in tqdm(image_paths, desc="Processing Images", unit="image"):
    ...
    nlm_filtered = cv2.fastNlMeansDenoisingColored(img, None, 30, 30, 3, 15)  # Non-local Means filter
...
image_to_show = list(filtered_images.keys())[18]  # Change the index to select another image
